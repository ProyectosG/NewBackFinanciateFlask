...
from src.models import db, PlanAhorro, Categoria,Egreso,Ingreso,Usuario
from flask_jwt_extended import jwt_required,get_jwt_identity
from datetime import date
from sqlalchemy.exc import SQLAlchemyError

#-----------------------------------------------------
plandeahorro_bp = Blueprint('plandeahorro', __name__,url_prefix = "/api/plandeahorro")
#-----------------------------------------------------

#---------------------------------------------------------
@plandeahorro_bp.route('/agregarplan', methods=['POST'])
@jwt_required()
def agregar_plan_ahorro():
